            ...
            <>
                ...
                <Div100vh className="main">
                    ...
                    <div className={'main__nav ' + (this.state.nav ? 'is-active' : '')}>
                        ...
                        <a href="#konserter-2019" className="main__nav-item hvr-shutter-out-horizontal">Konserter 2019</a>
                        ...
                        <a href="#bryllup" className="main__nav-item hvr-shutter-out-horizontal">Bryllup</a>
                ...
                <div className="display separator-top" id="konserter-2019">
                    <div className="left-half has-image">
                        <img src={require('../static/island_concert.jpg')} />
                    </div>
                ...
                <div className="display separator-top" id="bryllup">
                    ...
                    <div className="right-half has-image">
                        <img src={require('../static/island_wedding.jpg')} />
                    </div>
                </div>
                <div className="display separator-top" id="åpningstider">
                    <div className="left-half has-image">
                        <img src={require('../static/island_boat.jpg')} />
                    </div>
                    <div className="right-half">
                        <h1>Åpningstider</h1>
                ...
                <footer className="footer">
                    <div className="footer__content">
                        <p>Stangholmen Fyr 2019 &copy; | Site by <a href="https://alfi.dev/?s=stangholmenfyr" target="_blank">Alfi</a></p>
                    </div>
                </footer>
